...
class CheckRandomForest():
    def __init__(self):
        ...
        self.config = {'criterion': 'gini', 'max_depth': 529, 'n_estimators': 20}
        ...
        self.model = RandomForestClassifier(n_estimators=self.config['n_estimators'], criterion=self.config['criterion'],
