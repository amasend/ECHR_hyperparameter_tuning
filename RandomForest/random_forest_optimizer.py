...
parser.add_argument('--min_budget', type=float, help='Minimum number of epochs for training.', default=4)
...
parser.add_argument('--shared_directory', type=str, help='A directory that is accessible for all processes, '
                                                         'e.g. a NFS share.',
                    default='.\\random_forest_test')

args=parser.parse_args()

from random_forest_test import RandomForestWorker as worker
