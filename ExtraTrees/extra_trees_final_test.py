...
class CheckExtraTrees():
    def __init__(self):
        self.scoring = {'f1': F1, 'accuracy': ACC, 'MCC': MCC}
        # Best Configuration flavor desc
        # Test mean accuracy : 0.8919913419913421 std 0.021524556551416028
        # Test mean accuracy: 0.8919913419913421 std 0.021524556551416028
        # Test mean f - 1: 0.9397885739991004 std 0.010973784430940502
        # Train mean accuracy: 1.0 std 0.0
        # Train mean f - 1: 1.0  std 0.0
        # Train mean MCC: 1.0 std 0.0
        # Test mean MCC: 0.46065521775179247 std 0.23784663293594413
        self.config = {'n_estimators': 12, 'criterion': 'gini', 'max_depth': 120}
        ...
        self.model = ExtraTreesClassifier(n_estimators=self.config['n_estimators'], criterion=self.config['criterion'],
